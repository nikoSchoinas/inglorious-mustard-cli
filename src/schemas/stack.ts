 ...
 * with a plain-language justification, a monthly cost range (never a point
 * figure, §12) and exactly two alternatives. `locked: true` marks an
 * "I already decided" choice that must survive any redo (§8.7).
 */
